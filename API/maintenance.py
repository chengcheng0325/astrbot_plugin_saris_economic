...
class Equipment:
    ...
    def simulate_all_repairs(self) -> dict:
        ...
        for repair_type in repair_types:
            ...
            # 计算维修后的价值 (模拟维修后)
            all_results[repair_type]["simulated_current_value"] = round(equipment_copy.original_value * (all_results[repair_type]["new_current"] / equipment_copy.original_max), 2)
...
if __name__ == "__main__":
    ...
    # 输出模拟维修后的价值
    for repair_type, result in all_repair_results.items():
        print(f"模拟 {repair_type} 维修后的价值: {result['simulated_current_value']:.2f}元")
